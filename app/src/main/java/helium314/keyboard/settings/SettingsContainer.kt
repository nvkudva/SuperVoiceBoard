...
import helium314.keyboard.settings.screens.createPrivacyBreakingSettings // WaveKey
import helium314.keyboard.settings.screens.createVoiceSettings // WaveKey
...
private fun createSettings(context: Context) = createAboutSettings(context) + createAppearanceSettings(context) +
        ...
        createVoiceSettings(context) + createPrivacyBreakingSettings(context) + // WaveKey
...
object SettingsWithoutKey {
    ...
    const val BASED_ON = "based_on" // WaveKey: upstream attribution entry
