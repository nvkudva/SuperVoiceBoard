...
import helium314.keyboard.settings.screens.createPrivacyBreakingSettings // SuperVoiceBoard
import helium314.keyboard.settings.screens.createVoiceSettings // SuperVoiceBoard
...
private fun createSettings(context: Context) = createAboutSettings(context) + createAppearanceSettings(context) +
        ...
        createVoiceSettings(context) + createPrivacyBreakingSettings(context) + // SuperVoiceBoard
...
object SettingsWithoutKey {
    ...
    const val VOICE_MODELS = "voice_models_screen" // SuperVoiceBoard
}
